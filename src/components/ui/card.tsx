...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(({ className, ...props }, ref) => (
  <div ref={ref} className={cn("rounded-xl border border-border/50 bg-card text-card-foreground shadow-card transition-all duration-150 ease-out hover:shadow-card-hover hover:border-border/70", className)} {...props} />
));
